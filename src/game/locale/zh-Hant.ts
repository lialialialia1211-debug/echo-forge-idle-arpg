...
const messages: Record<string, string> = {
  ...
  "ui.brand.name": "迴響鍛爐",
  "ui.brand.subtitle": "戰鬥陀螺放置 ARPG",
  "ui.state.ready": "待命",
  "ui.state.live": "戰鬥中",
  "ui.state.defeated": "已敗北",
  "ui.state.keyed": "鑰匙已啟動",
  "ui.resource.ash": "金幣",
  "ui.resource.glass": "強化石",
  "ui.resource.echo": "核心",
  "ui.resource.energyShort": "能",
  "ui.screen.combat": "戰鬥",
  "ui.screen.map": "關卡",
  "ui.screen.workbench": "裝備",
  "ui.control.start": "開始",
  "ui.control.pause": "暫停",
  "ui.control.reset": "重置",
  "ui.control.debug": "除錯",
  ...
  "ui.control.allocate": "套用",
  "ui.control.routeMap": "關卡圖",
  "ui.control.combat": "戰鬥",
  "ui.control.loot": "戰利品",
  "ui.control.startDuel": "開始決鬥",
  "ui.control.forgeKey": "製作鑰匙",
  "ui.control.runKey": "使用鑰匙",
  "ui.panel.loadout": "裝備",
  "ui.panel.inventory": "背包",
  "ui.panel.skills": "技能",
  "ui.panel.forge": "強化",
  "ui.panel.route": "關卡",
  "ui.panel.talents": "天賦",
  "ui.section.buildSummary": "戰力摘要",
  "ui.section.selectedPart": "選中裝備",
  "ui.section.forgeTarget": "強化目標",
  "ui.section.equipment": "裝備",
  "ui.section.frame": "框架",
  "ui.section.inventory": "背包",
  "ui.section.recentLoot": "近期戰利品",
  "ui.section.driveCore": "主技能",
  "ui.section.skillDetail": "技能細節",
  "ui.section.linkedSockets": "技能連結",
  "ui.section.runeLibrary": "技能符文",
  "ui.section.actions": "操作",
  "ui.section.route": "關卡",
  "ui.section.circuit": "章節",
  "ui.section.breachRail": "限時獎勵",
  "ui.section.circuitAtlas": "關卡天賦",
  "ui.section.arenaKeys": "關卡鑰匙",
  "ui.section.bossGate": "Boss 挑戰",
  "ui.section.circuitNetwork": "關卡路線",
  "ui.section.clears": "通關",
  "ui.section.talents": "天賦",
  "ui.section.endgameMasters": "終局專精",
  "ui.section.inspector": "詳細資訊",
  "ui.section.damageBreakdown": "傷害詳情",
  "ui.section.breakpoints": "戰力門檻",
  "ui.section.combatData": "戰力數據",
  ...
  "ui.inventory.noPart": "未選取裝備",
  "ui.inventory.noKey": "沒有關卡鑰匙",
  "ui.inventory.chooseRune": "選擇相容的技能符文。",
  "ui.rune.catalog": "圖鑑",
  ...
  "ui.routePlan.kicker": "下一步",
  "ui.routePlan.title": "照順序推進",
  "ui.routePlan.detail": "先刷裝、再開下一關；鑰匙是想要更高獎勵時才使用。",
  "ui.routePlan.expand": "進階地圖",
  "ui.routePlan.collapse": "收起進階地圖",
  "ui.routePlan.continueFarm": "繼續刷裝",
  "ui.routePlan.running": "戰鬥中",
  "ui.routePlan.start": "開始",
  "ui.routePlan.challengeNext": "挑戰下一關",
  "ui.routePlan.selectRoute": "選關",
  "ui.routePlan.completed": "已完成",
  "ui.routePlan.keyFallback": "有材料再做",
  "ui.routePlan.keyDetail": "獎勵 {reward} / 壓力 {pressure}",
  "ui.routePlan.chapterProgress": "主線 {done}/{total}",
  "ui.routePlan.nextRoute": "下一關 {name}",
  "ui.routePlan.kills": "擊破 {count}",
  "ui.home.firstRunKicker": "第一場",
  "ui.home.mainKicker": "主畫面",
  "ui.home.firstRunTitle": "開始刷裝",
  "ui.home.hubTitle": "戰鬥據點",
  "ui.home.hubDetail": "回來收戰利品、強化裝備，然後挑戰下一關。",
  "ui.home.uniqueNext": "唯一下一步",
  "ui.home.supportTitle": "輔助入口",
  "ui.home.chapterComplete": "第一章已完成，開始挑選長線刷裝關卡。",
  "ui.home.chapterProgress": "主線 {done}/{total}，目前先處理上方主行動。",
  "ui.home.progressLabel": "主線步驟",
  "ui.map.deviceArmed": "鑰匙裝置已啟動",
  "ui.map.circuitMap": "章節地圖",
  "ui.map.routeMap": "關卡地圖",
  "ui.point.short": "點",
  "ui.drop.none": "尚無掉落",
  ...
  "tutorial.welcome.title": "先開始刷第一關",
  "tutorial.welcome.body": "按「開始」讓陀螺自動戰鬥。先收戰利品、換上更強裝備，再推進下一關。",
  "tutorial.firstDrop.title": "第一件戰利品",
  "tutorial.firstDrop.body": "掉落會自動進入待檢清單。稀有度越高，越可能帶來能改變手感的詞綴。",
  "tutorial.firstEquip.title": "檢查能否升級",
  "tutorial.firstEquip.body": "選中裝備後看右側比較。若顯示值得裝備，就換上它讓下一輪更穩。",
  "tutorial.firstTalent.title": "天賦點開始累積",
  "tutorial.firstTalent.body": "每 5 次擊破給 1 點天賦。打開「天賦」，從中心往外點。",
  "tutorial.firstForge.title": "強化裝備",
  "tutorial.firstForge.body": "強化可以升級、重骰或補上詞綴。材料不多時，優先投資已裝備的核心裝備。",
  ...
  "tutorial.mapUnlock.title": "打開關卡",
  "tutorial.mapUnlock.body": "關卡會顯示第一章進度、特殊挑戰和 Boss。從亮起的節點開始推進。",
  "tutorial.rivalGate.title": "名宿決鬥",
  "tutorial.rivalGate.body": "強敵有獨特機制。首通會給一件帶特殊詞綴的裝備與核心，值得優先處理。",
  "tutorial.firstKey.title": "關卡鑰匙",
  "tutorial.firstKey.body": "鑰匙會提高風險和獎勵。可以製作鑰匙，也可以使用鑰匙直接進入加壓關卡。",
  "tutorial.firstAnomaly.title": "特殊關卡",
  "tutorial.firstAnomaly.body": "Anomaly 會改變規則，同時提高回報。先看節點詳情，再決定要不要開。",
  "tutorial.bossGate.title": "Boss 挑戰",
  "tutorial.bossGate.body": "Boss 挑戰會檢查傷害、命中、防禦與抗性。成功首通會解鎖後續關卡並給獎勵。",
  "ui.build.stable": "戰力穩定",
  "ui.forge.upgrade": "升級",
  "ui.forge.upgradeDetail": "提高稀有度",
  "ui.forge.reroll": "重骰",
  "ui.forge.rerollDetail": "重骰詞綴",
  "ui.forge.values": "數值",
  "ui.forge.valuesDetail": "同詞綴重骰",
  "ui.forge.add": "新增",
  "ui.forge.addDetail": "新增一條詞綴",
  "ui.forge.remove": "移除",
  "ui.forge.removeDetail": "移除一條詞綴",
  "ui.target.none": "沒有目標",
  ...
  "ui.damage.target": "對象",
  "ui.combatData.collapsed": "進階戰力數據已收合。調整裝備時可展開檢查傷害與門檻。",
  ...
  "ui.endgame.preview": "終局預覽",
  "ui.endgame.recommendedNodes": "推薦 4 點",
  "ui.endgame.activeSignal": "主訊號",
  "ui.endgame.missing": "補強",
  "ui.endgame.activeNodes": "已配置",
  ...
  "ui.next.forgeCandidate": "推薦強化",
  "ui.next.equipUpgrade": "推薦裝備",
  "ui.next.keyReady": "關卡鑰匙已準備",
  "ui.next.bossViable": "Boss 可以挑戰",
  "ui.next.ready": "準備開始",
  "ui.next.now": "現在",
  "ui.next.signal": "訊號",
  "ui.next.then": "下一步",
  ...
  "ui.next.adjustBuild": "調整裝備",
  "ui.next.checkBuild": "檢查裝備",
  "ui.next.secureDrops": "保住掉落",
  "ui.next.openLoot": "開啟戰利品",
  "ui.next.finishBoss": "擊碎 Boss",
  "ui.next.checkRouteKey": "檢查關卡鑰匙",
  "ui.next.holdCenter": "守住中心",
  "ui.next.fightBoss": "迎戰 Boss",
  "ui.next.keepFarming": "持續刷場",
  "ui.next.pushBoss": "推進 Boss",
  "ui.next.inspectLoot": "整理戰利品",
  "ui.next.forgeRoll": "強化後再檢查",
  "ui.next.restart": "重啟本場",
  "ui.next.craftPart": "強化裝備",
  "ui.next.recheckBuild": "看戰力變化",
  "ui.next.improveBuild": "強化裝備",
  "ui.next.swapPart": "替換裝備",
  "ui.next.startRun": "開始戰鬥",
  "ui.next.chooseRoute": "選下一關",
  "ui.next.attemptGate": "挑戰 Boss",
  "ui.next.unlockRoute": "解鎖下一關",
  ...
  "ui.verdict.equippedDetail": "這件裝備已裝上。",
  "ui.verdict.upgrade": "推薦裝備",
  "ui.verdict.forge": "推薦強化",
  "ui.verdict.salvage": "可拆解",
  "ui.verdict.forgeDetail": "戰力 {score} / 可以再強化。",
  "ui.verdict.salvageDetail": "戰力 {score} / 目前裝備較強。",
  ...
  "ui.objective.shatterBoss": "擊敗 Boss 取得下一關鑰匙",
  ...
  "ui.aria.inventoryFilter": "背包篩選",
  "ui.aria.inventoryGrid": "背包格",
  "ui.aria.linkedSockets": "連結技能槽",
  "ui.aria.atlasBoard": "關卡天賦盤",
  "ui.aria.doctrinePaths": "教義路徑",
  "ui.aria.workbench": "裝備",
  "ui.aria.nextAction": "下一步",
  "ui.aria.decisionSignals": "決策訊號",
  "ui.aria.routeObjective": "關卡目標",
...
const terms: Record<string, string> = {
  ...
  "tag.thorns": "反擊",
  "tag.risk": "風險",
  "endgameSignal.routeClears": "路線通關",
  "endgameSignal.arenaKeys": "競技場鑰匙",
  "endgameSignal.materials": "材料儲備",
  "endgameSignal.bossGates": "Boss 門",
  "endgameSignal.rivals": "名宿通關",
  "endgameSignal.kills": "擊破數",
  "endgameReward.routeReward": "路線獎勵",
  "endgameReward.keySustain": "鑰匙續航",
  "endgameReward.forgeControl": "鍛造控制",
  "endgameReward.affixControl": "詞綴控制",
  "endgameReward.materialLoop": "材料循環",
  "endgameReward.rivalDuel": "名宿決鬥",
  "endgameReward.bossGate": "Boss 門",
  "endgameReward.uniqueChase": "傳奇追獵",
...
const dataText: Record<string, string> = {
  ...
  "endgameMaster.master_mapwright.name": "製圖者",
  "endgameMaster.master_mapwright.desc": "把路線通關與備用鑰匙轉成穩定的終局地圖循環。",
  "endgameMaster.master_forgesmith.name": "鍛爐師",
  "endgameMaster.master_forgesmith.desc": "把拆解、媒材與路線收益轉成更好的詞綴控制。",
  "endgameMaster.master_rivalhunter.name": "名宿獵人",
  "endgameMaster.master_rivalhunter.desc": "把 Boss 門、名宿與傳奇追獵目標集中成一條獵殺計畫。",
  "endgameMasterNode.master_mapwright_route_survey.name": "路線測繪",
  "endgameMasterNode.master_mapwright_blank_keys.name": "空白鑰匙",
  "endgameMasterNode.master_mapwright_basin_ledger.name": "盆地帳冊",
  "endgameMasterNode.master_mapwright_cache_route.name": "寶庫路線",
  "endgameMasterNode.master_mapwright_key_recycling.name": "鑰匙回收",
  "endgameMasterNode.master_mapwright_signal_chart.name": "訊號圖表",
  "endgameMasterNode.master_mapwright_stacked_exits.name": "堆疊出口",
  "endgameMasterNode.master_mapwright_toll_math.name": "通行費算式",
  "endgameMasterNode.master_mapwright_apex_pin.name": "尖頂釘點",
  "endgameMasterNode.master_mapwright_endless_lane.name": "無盡通道",
  "endgameMasterNode.master_mapwright_contract_press.name": "契約壓印",
  "endgameMasterNode.master_mapwright_brass_cartography.name": "黃銅製圖",
  "endgameMasterNode.master_forgesmith_scrap_tithe.name": "廢料什一",
  "endgameMasterNode.master_forgesmith_measured_heat.name": "量測爐熱",
  "endgameMasterNode.master_forgesmith_media_bins.name": "媒材箱",
  "endgameMasterNode.master_forgesmith_reroll_jig.name": "重骰夾具",
  "endgameMasterNode.master_forgesmith_affix_clamp.name": "詞綴夾具",
  "endgameMasterNode.master_forgesmith_quench_table.name": "淬熄桌",
  "endgameMasterNode.master_forgesmith_echo_mold.name": "迴響模具",
  "endgameMasterNode.master_forgesmith_engraving_lane.name": "銘刻通道",
  "endgameMasterNode.master_forgesmith_keyed_furnace.name": "鑰匙熔爐",
  "endgameMasterNode.master_forgesmith_masterwork_press.name": "名匠壓床",
  "endgameMasterNode.master_forgesmith_tempered_contract.name": "淬鍊契約",
  "endgameMasterNode.master_forgesmith_null_sieve.name": "虛無篩",
  "endgameMasterNode.master_rivalhunter_name_board.name": "名牌板",
  "endgameMasterNode.master_rivalhunter_gate_scent.name": "門痕氣味",
  "endgameMasterNode.master_rivalhunter_blooded_route.name": "染血路線",
  "endgameMasterNode.master_rivalhunter_contract_mark.name": "契約標記",
  "endgameMasterNode.master_rivalhunter_phase_read.name": "階段解讀",
  "endgameMasterNode.master_rivalhunter_keyed_lure.name": "鑰匙誘餌",
  "endgameMasterNode.master_rivalhunter_trophy_wire.name": "戰利品線",
  "endgameMasterNode.master_rivalhunter_boss_ledger.name": "Boss 帳冊",
  "endgameMasterNode.master_rivalhunter_chase_pressure.name": "追獵壓力",
  "endgameMasterNode.master_rivalhunter_named_quarry.name": "具名獵物",
  "endgameMasterNode.master_rivalhunter_judicator_writ.name": "裁決者令狀",
  "endgameMasterNode.master_rivalhunter_relic_scent.name": "傳奇氣味",
};
...
export function translateRuntimeText(text: string): string {
  const exact: Record<string, string> = {
    ...
    "Furnace pressure hardens enemies and improves engraved drops.": "熔爐壓力讓敵人更堅硬，也提高特殊詞綴掉落。",
